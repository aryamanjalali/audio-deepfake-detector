...
class DeepfakeDetector:
    ...
    def apply_codec_simulation(self, audio_path: str, simulation: str):
        ...
        # Map simulation names to codec simulator methods
        simulation_map = {
    ...
    def predict(self, audio_path: str, model_type: str, simulation: str):
        ...
        try:
            ...
            if model_type == 'wav2vec2':
                # wav2vec2 uses raw audio
                # Try different backends to avoid torchcodec dependency
                try:
                ...
                # CNN models use spectrograms
                mel_spec = self.preprocessor.process_audio(processed_path, max_duration=4.0)
                input_tensor = mel_spec.unsqueeze(0).to(self.device)  # Add batch dimension
            ...
            fake_prob = confidence[1] * 100  # Probability of fake
            real_prob = confidence[0] * 100  # Probability of real
            ...
            # Create spectrogram if CNN model
            spec_fig = None
            if model_type != 'wav2vec2':
